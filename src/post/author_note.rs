...
fn add_mark(mut doc: String, name: &str) -> Result<String, String> {
    ...
    let name_replace = format!("{}</w:t></w:r><w:r><w:rPr><w:rStyle w:val=\"FootnoteReference\" /></w:rPr><w:footnoteReference w:customMarkFollows=\"1\" w:id=\"-999\"/><w:t>*</w:t></w:r>", last_name);
...
fn add_note(mut fns: String, note: String) -> Result<String, String> {
    let fns_find = r#"<w:footnote w:id="(?P<f>[1-9]\d*)">"#.to_string();
    let fns_replace = format!("<w:footnote w:id=\"-999\"><w:p><w:pPr><w:pStyle w:val=\"FootnoteText\"/></w:pPr><w:r><w:rPr><w:rStyle w:val=\"FootnoteReference\" /></w:rPr><w:t>*</w:t></w:r><w:r><w:t xml:space=\"preserve\"> </w:t></w:r><w:r><w:t xml:space=\"preserve\">{}</w:t></w:r></w:p></w:footnote><w:footnote w:id=\"$f\">", note);
...
mod tests {
    ...
    fn test_add_mark() {
        ...
        assert_eq!(doc, r#"<w:r><w:t xml:space="preserve">Test</w:t></w:r><w:r><w:t xml:space="preserve"> </w:t></w:r><w:r><w:t xml:space="preserve">Author</w:t></w:r><w:r><w:rPr><w:rStyle w:val="FootnoteReference" /></w:rPr><w:footnoteReference w:customMarkFollows="1" w:id="-999"/><w:t>*</w:t></w:r></w:p>"#.to_string())
    }

    #[test]
    fn test_add_note() {
        let mut fns = r#"<w:footnote w:type="continuationSeparator" w:id="0"><w:p><w:r><w:continuationSeparator /></w:r></w:p></w:footnote><w:footnote w:type="separator" w:id="-1"><w:p><w:r><w:separator /></w:r></w:p></w:footnote><w:footnote w:id="20">"#.to_string();
